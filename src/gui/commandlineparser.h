...
#ifndef NANOSPECTRUM_COMMAND_LINE_PARSER_H
#define NANOSPECTRUM_COMMAND_LINE_PARSER_H
...
namespace nanospectrum {
    ...
    class NANOSPECTRUM_GUI_EXPORT CommandLineParser
    {
    public:
...
#endif // NANOSPECTRUM_COMMAND_LINE_PARSER_H
