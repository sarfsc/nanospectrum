...
#ifndef NANOSPECTRUM_PLUGINSTORAGE_H
#define NANOSPECTRUM_PLUGINSTORAGE_H
 ...
 *
 * \ingroup nanospectrum
 */
class NANOSPECTRUM_MODEL_EXPORT PluginStorage
{
public:
    /*!
     * \brief getPlugin
...
#endif // NANOSPECTRUM_PLUGINSTORAGE_H
